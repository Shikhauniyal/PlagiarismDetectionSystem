...
def pay_invoice(request, pk):
    ...
    if invoice:
        qs = {
            'cmd': '_xclick',
            'business': 'payments@plagiarismguardian.com',
            'item_name': 'Plagiarism Guardian',
...
def data_cleanse(request):
    ...
    sentiment_analysis = File(open(r'C:\PlagiarismGuardian\mediaroottest\testfiles\Sentiment Analysis.pdf', mode='rb'))
    ...
    johnny_sell = File(open(r'C:\PlagiarismGuardian\mediaroottest\testfiles\Why Johnny Cant Sell.PDF', mode='rb'))
    ...
    random_docx = File(open(r'C:\PlagiarismGuardian\mediaroottest\testfiles\Random Doc.docx', mode='rb'))
    ...
    intro_nlp = File(open(r'C:\PlagiarismGuardian\mediaroottest\testfiles\Introduction to NLP.pptx', mode='rb'))
    ...
    cl_links = File(open(r'C:\PlagiarismGuardian\mediaroottest\testfiles\ComputerLover links.txt', mode='r'))
    ...
    bronafon_pack = File(open(r'C:\PlagiarismGuardian\mediaroottest\testfiles\BronAfonApplicationPack.doc', mode='rb'))
